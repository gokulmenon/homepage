  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="w-full max-w-lg" disabled>
      ...
      <label className="block mb-5">
        ...
        <input name="name" type="text" ref={register({required: true})} className="shadow border rounded py-2 px-3 form-input mt-1 block w-full" placeholder="First Last "/>
      </label>
      <label className="block mb-5">
      ...
      <label className="block mb-5">
        ...
        <textarea ref={register({required: true})} name="comment" className="shadow border rounded py-2 px-3  form-textarea mt-1 block w-full" rows="8" placeholder="Enter your comment"></textarea>
      </label>
